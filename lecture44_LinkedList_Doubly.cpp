...
void deleteAtPosition(Node* &head, Node* tail, int pos)
{
    ...
    else
    {
        ...
        if(temp -> next == curr -> next && curr -> next == NULL && curr -> prev == NULL)
        {
            tail = temp;
        }
        delete curr;    
...
Node* reverse(Node* &head)
{
    ...
    cout << "\nData after reversing of node" << endl;
    return prev;
}
...
int main() 
{
    ...
    insertAtPosition(head, tail, 5, 899);
    print(head);
    ...
    cout << "Length of Linked List => " << getLength(newNode) << endl;
    cout << endl;
