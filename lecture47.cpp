...
///////
//There are 5 ways of removing loops & 3 ways of detecting cycle in a loop
...
//dectecting loop in O(n) time complexity and space complexity
...
//detect loop
//Advantage to reduce the space complexity to constant O(1) from 'n'
...
//DO HW : all 5-ways of loop removing and all 3-ways of cycle detection
